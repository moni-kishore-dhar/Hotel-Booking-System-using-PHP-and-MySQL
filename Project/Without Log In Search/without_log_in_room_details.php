...
<ul>
    ...
    <li><a href="/Project/sign_up_try.php">Sign Up</a></li>
    <li><a href="/Project/sign_in_try.php">Sign In</a></li>
    <li><a href="/Project/home_page_try.php">Home</a></li>
...
?>
       ...
       <font size="4"> 
            <table width="80%">
              <tr>
        <td><a href="without_log_in_room_details.php?var1=<?php echo $room_type_id;?>"><font color="black"><font size="4"><?php echo $row['room_type_catagory'];?></font></font></a></td>
      </tr>
...
<a href="/Project/sign_in_try.php?var2=<?php echo $room_id;?>"><font color="black"><font size="8"><b>Book</b></font></font></a>
